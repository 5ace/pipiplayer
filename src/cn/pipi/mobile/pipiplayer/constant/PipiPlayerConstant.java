...
public class PipiPlayerConstant {
	...
	String[] sources = { "默认","标清","高清","超清","优酷", "乐视", "爱奇艺", "腾讯", "土豆", "搜狐",
			"网易","新浪" ,"酷6","迅雷","激动网","华数","PPS","PPTV","风行","CNTV","电影网"};
	Integer[] iconSource={R.drawable.iconpipi,R.drawable.iconpipi,R.drawable.iconpipi,
			R.drawable.iconpipi,R.drawable.iconyouku,R.drawable.iconleshi,R.drawable.iconqiy,
			R.drawable.icontengxun,R.drawable.icontudou,R.drawable.iconsouhu,R.drawable.iconwangyi,
			R.drawable.iconxinlang,R.drawable.iconku6,R.drawable.iconxunlei,R.drawable.iconjidong,
			R.drawable.iconhuashu,R.drawable.iconpps,R.drawable.iconpptv,R.drawable.iconfengxing,
			R.drawable.iconcntv,R.drawable.iconm1905};
	...
	public PipiPlayerConstant(){
		...
		try {
			...
			dver = URLEncoder.encode(VLCApplication.getAppResources().getString(R.string.pipiplayer_versionname), "UTF-8");
