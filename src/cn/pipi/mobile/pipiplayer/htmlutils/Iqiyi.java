	...
	//http://v.qq.com/cover/z/z53amptli0891ds.html
	 ...
	 public  List<String> getDownloadInfo(String url,int parseMode) {
		 ...
		 if(!TextUtils.isEmpty(vid)){
			...
			//http://122.228.102.144/videos/v/20131228/79bd170acc821af76ceb3011773380b5.f4v?key=633253814bf757d2&retry=1&uuid=1a9b42b356bf69ece5fe0580119928c8b3fbed98fa1138c26e9d3ebf84a13c2d		 
		 }
	        return downloadInfo;
	    }
