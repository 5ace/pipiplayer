...
public class DownloadApp extends AsyncTask<String, Float, Boolean>{
	...
	public DownloadApp(Context context,DownloadAPK downloadAPK,Handler handler,boolean oldUrl){
