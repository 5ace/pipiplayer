...
public class LibVLC {
    private static final String TAG = "PipiPlayer/LibVLC";
    ...
    static {
        ...
        try {
            ...
            Log.e(TAG, "Can't load TransmitLayer library: " + ule);
            /// FIXME Alert user
            System.exit(1);
        ...
        try {
            ...
            Log.e(TAG, "Can't load FileSession library: " + ule);
            /// FIXME Alert user
            System.exit(1);
        } catch (SecurityException se) {
            Log.e(TAG, "Encountered a security issue when loading vlcjni library: " + se);
    ...
    public void init(Context context) throws LibVlcException {
        ...
        if (!mIsInitialized) {
            ...
            String osType = "aphone";
								String DeviceUDID = PipiPlayerConstant.getInstance().UUID; //from device UDID
								String DocDir = FileUtils.getFileConfDir();
								String confDir = FileUtils.getFileConfDir();
			nativeInitp2pInformation(DocDir,confDir,PipiPlayerConstant.getInstance().dver,osType,DeviceUDID);
    ...
    public native void nativeInitp2pInformation(String DocDir, String confDir, String version,
			String osType,String deviceUDID);
    public native void nativeExitp2pSystem();
    	
    public native String nativeGeneralPlayerTask(String filmHashID, String SavePath);
    
    public native String nativeGeneralHashID(String filmHashID);
    public native void nativeStopPlayerTask(String filmHashID);
    public native String nativeGetLocalFileName(String filmHashID);
    public native String nativeGetFileLoadPath(String filmuri);
    public native String nativeGetDownloadInfo(String filmuri);
    public native void nativeSetStopCurReadTask(String filmuri,int flag);
    public native int nativeIsHeaderBufferingComplete(String filmuri);
    public native int nativeGetCurFileSize(String filmuri);
    public native int nativePause(String filmuri);
    public native int nativeResume(String filmuri);
    public native int nativeDelete(String filmuri, boolean bComplete);
    public native int nativeFileMerge(String mp4filepath,String[] filearray,boolean bDeleteFile);
    public native int nativeDeleteFileCacheFromPPfilme(String filmHashID,String filecacheDir);
