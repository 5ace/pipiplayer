...
import cn.pipi.mobile.pipiplayer.local.libvlc.MediaList;
...
import cn.pipi.mobile.pipiplayer.local.vlc.interfaces.IAudioService;
import cn.pipi.mobile.pipiplayer.local.vlc.interfaces.IAudioServiceCallback;
...
public class AudioService extends Service {
    ...
    public static final String ACTION_REMOTE_GENERIC = "cn.pipi.mobile.pipiplayer.local.vlc.remote.";
    public static final String ACTION_REMOTE_BACKWARD = "cn.pipi.mobile.pipiplayer.local.vlc.remote.Backward";
    public static final String ACTION_REMOTE_PLAY = "cn.pipi.mobile.pipiplayer.local.vlc.remote.Play";
    public static final String ACTION_REMOTE_PLAYPAUSE = "cn.pipi.mobile.pipiplayer.local.vlc.remote.PlayPause";
    public static final String ACTION_REMOTE_PAUSE = "cn.pipi.mobile.pipiplayer.local.vlc.remote.Pause";
    public static final String ACTION_REMOTE_STOP = "cn.pipi.mobile.pipiplayer.local.vlc.remote.Stop";
    public static final String ACTION_REMOTE_FORWARD = "cn.pipi.mobile.pipiplayer.local.vlc.remote.Forward";
    public static final String ACTION_REMOTE_LAST_PLAYLIST = "cn.pipi.mobile.pipiplayer.local.vlc.remote.LastPlaylist";
    public static final String ACTION_WIDGET_INIT = "cn.pipi.mobile.pipiplayer.local.vlc.widget.INIT";
    public static final String ACTION_WIDGET_UPDATE = "cn.pipi.mobile.pipiplayer.local.vlc.widget.UPDATE";
    public static final String ACTION_WIDGET_UPDATE_COVER = "cn.pipi.mobile.pipiplayer.local.vlc.widget.UPDATE_COVER";
    public static final String ACTION_WIDGET_UPDATE_POSITION = "cn.pipi.mobile.pipiplayer.local.vlc.widget.UPDATE_POSITION";

    public static final String WIDGET_PACKAGE = "cn.pipi.mobile.pipiplayer.local.vlc";
    public static final String WIDGET_CLASS = "cn.pipi.mobile.pipiplayer.local.vlc.widget.VLCAppWidgetProvider";
    ...
    private final BroadcastReceiver serviceReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.startsWith(ACTION_REMOTE_GENERIC) && !mLibVLC.isPlaying() && !hasCurrentMedia()) {
                Intent iVlc = new Intent(context, MainLocalActivity.class);
    ...
    private void showNotification() {
        try {
            ...
            NotificationCompat.Builder builder = new NotificationCompat.Builder(this)
                .setSmallIcon(R.drawable.iconpipi)
                .setTicker(title + " - " + artist)
                .setAutoCancel(false)
                .setOngoing(true);

            Intent notificationIntent = new Intent(this, MainLocalActivity.class);
            notificationIntent.setAction(MainLocalActivity.ACTION_SHOW_PLAYER);
            ...
            if (LibVlcUtil.isJellyBeanOrLater()) {
                ...
                RemoteViews view = new RemoteViews(getPackageName(), R.layout.local_notification);
                if (cover != null)
                ...
                RemoteViews view_expanded = new RemoteViews(getPackageName(), R.layout.local_notification_expanded);
                if (cover != null)
    ...
    private void updateWidgetState(Context context) {
        ...
        if (hasCurrentMedia()) {
            ...
            i.putExtra("title", context.getString(R.string.app_name));
            i.putExtra("artist", "");
        }
