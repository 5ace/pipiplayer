...
import cn.pipi.mobile.pipiplayer.local.vlc.interfaces.OnExpandableListener;
import cn.pipi.mobile.pipiplayer.local.vlc.widget.ExpandableLayout;
...
public class CommonDialogs {
    public final static String TAG = "PipiPlayer/CommonDialogs";
    ...
    public static void advancedOptions(final Context context, View v, MenuType t) {
        ...
        View view = inflater.inflate(R.layout.local_advanced_options, null);
