...
import cn.pipi.mobile.pipiplayer.local.android.ui.SherlockGridFragment;
...
import cn.pipi.mobile.pipiplayer.local.vlc.Thumbnailer;
import cn.pipi.mobile.pipiplayer.local.vlc.Util;
import cn.pipi.mobile.pipiplayer.local.vlc.VlcRunnable;
...
public class VideoGridFragment extends SherlockGridFragment implements ISortable {
    ...
    public final static String TAG = "PipiPlayer/VideoListFragment";

    protected static final String ACTION_SCAN_START = "cn.pipi.mobile.pipiplayer.local.vlc.gui.ScanStart";
    protected static final String ACTION_SCAN_STOP = "cn.pipi.mobile.pipiplayer.local.vlc.gui.ScanStop";
    ...
    {
        View v = inflater.inflate(R.layout.local_video_grid, container, false);
