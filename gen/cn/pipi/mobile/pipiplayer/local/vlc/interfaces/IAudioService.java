 ...
 * Original file: D:\\pipiclient_android\\player_phone_new\\src\\cn\\pipi\\mobile\\pipiplayer\\local\\vlc\\interfaces\\IAudioService.aidl
 */
package cn.pipi.mobile.pipiplayer.local.vlc.interfaces;
public interface IAudioService extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements cn.pipi.mobile.pipiplayer.local.vlc.interfaces.IAudioService
{
private static final java.lang.String DESCRIPTOR = "cn.pipi.mobile.pipiplayer.local.vlc.interfaces.IAudioService";
...
/**
 * Cast an IBinder object into an cn.pipi.mobile.pipiplayer.local.vlc.interfaces.IAudioService interface,
 * generating a proxy if needed.
 */
public static cn.pipi.mobile.pipiplayer.local.vlc.interfaces.IAudioService asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof cn.pipi.mobile.pipiplayer.local.vlc.interfaces.IAudioService))) {
return ((cn.pipi.mobile.pipiplayer.local.vlc.interfaces.IAudioService)iin);
}
return new cn.pipi.mobile.pipiplayer.local.vlc.interfaces.IAudioService.Stub.Proxy(obj);
}
...
{
data.enforceInterface(DESCRIPTOR);
cn.pipi.mobile.pipiplayer.local.vlc.interfaces.IAudioServiceCallback _arg0;
_arg0 = cn.pipi.mobile.pipiplayer.local.vlc.interfaces.IAudioServiceCallback.Stub.asInterface(data.readStrongBinder());
...
private static class Proxy implements cn.pipi.mobile.pipiplayer.local.vlc.interfaces.IAudioService
{
...
@Override public void addAudioCallback(cn.pipi.mobile.pipiplayer.local.vlc.interfaces.IAudioServiceCallback cb) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public void removeAudioCallback(cn.pipi.mobile.pipiplayer.local.vlc.interfaces.IAudioServiceCallback cb) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
public void addAudioCallback(cn.pipi.mobile.pipiplayer.local.vlc.interfaces.IAudioServiceCallback cb) throws android.os.RemoteException;
public void removeAudioCallback(cn.pipi.mobile.pipiplayer.local.vlc.interfaces.IAudioServiceCallback cb) throws android.os.RemoteException;
